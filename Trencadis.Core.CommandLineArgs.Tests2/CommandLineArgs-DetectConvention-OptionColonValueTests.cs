...
{
  [TestClass]
  public class CommandLineArgs_DetectConvention_OptionColonValueTests
  {
    #region Happy Path

    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_happy_case_scenario()
    {
      ...
      Assert.AreEqual(ArgOptionsConvention.OptionColonValue, convention);
    }
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_value_on_first_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_value_on_middle_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_value_on_last_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_name_on_first_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_name_on_middle_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_OptionColonValue_for_missing_option_name_on_last_param()
    {
