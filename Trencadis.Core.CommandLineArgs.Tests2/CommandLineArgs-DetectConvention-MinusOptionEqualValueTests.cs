...
{
  [TestClass]
  public class CommandLineArgs_DetectConvention_MinusOptionEqualValueTests
  {
    #region Happy Path

    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_happy_case_scenario()
    {
      ...
      Assert.AreEqual(ArgOptionsConvention.MinusOptionEqualValue, convention);
    }
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_value_on_first_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_value_on_middle_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_value_on_last_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_name_on_first_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_name_on_middle_param()
    {
    ...
    [TestMethod]
    public void Test_that_DetectConvention_returns_MinusOptionEqualValue_for_missing_option_name_on_last_param()
    {
